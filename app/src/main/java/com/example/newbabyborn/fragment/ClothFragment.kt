...
import com.example.newbabyborn.databinding.FragmentClothBinding
                ...
                if (snapshot.hasChildren()) {
                    ...
                    if (contact != null) {
                        ...
                        if(contact.itemType.toInt()==2)
                        {
                            ...
                            val adapter = BabayItemAdapter(itemList,requireContext(),::addItem,::shareItem,::locationItem)
                            binding.clothingRecyclarView.layoutManager =
                                LinearLayoutManager(requireContext(), RecyclerView.VERTICAL, false)
                            binding.clothingRecyclarView.adapter = adapter
                        }
